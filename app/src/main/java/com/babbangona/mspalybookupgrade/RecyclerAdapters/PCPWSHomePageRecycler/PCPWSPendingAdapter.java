...
public class PCPWSPendingAdapter extends PagedListAdapter<PCPWSRecyclerModel, PCPWSPendingAdapter.ViewHolder> {
    ...
    public PCPWSPendingAdapter(Context context) {
        super(USER_DIFF);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        void nowBind(PCPWSRecyclerModel pcpwsRecyclerModel){
            ...
            btn_act_action.setText(context.getResources().getString(R.string.pws_review_claim));

            btn_act_action.setOnClickListener(v -> reviewClaim(appDatabase.pwsActivitiesFlagDao().getFieldDetails(pcpwsRecyclerModel.getUnique_field_id()), pcpwsRecyclerModel.getPws_id()));
        }

        void reviewClaim(PWSFieldListRecyclerModel pwsFieldListRecyclerModel, String pws_id){
            sharedPrefs.setKeyPWSFieldModel(pwsFieldListRecyclerModel);
            sharedPrefs.setKeyPwsId(pws_id);

            FragmentManager fragmentManager = ((FragmentActivity)context).getSupportFragmentManager();
            RevPWSDialogFragment newFragment = new RevPWSDialogFragment();
