...
public class PWSFieldListPageListModelClass extends ViewModel {
    ...
    public final LiveData<PagedList<PWSFieldListRecyclerModel>> pwsFieldListRecyclerModel;
    public MutableLiveData<String> filterTextAll       = new MutableLiveData<>();

    public PWSFieldListPageListModelClass(FieldsDao fieldsDao, Context context) {
        this.fieldsDao = fieldsDao;
        this.context = context;
        SharedPrefs sharedPrefs = new SharedPrefs(this.context);
        String staff_id = "%"+sharedPrefs.getStaffID()+"%";

        pwsFieldListRecyclerModel = Transformations.switchMap(filterTextAll, input -> {
            if (input == null || input.equals("") || input.equals("%%") ||input.equals("% %")) {
                ...
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListByStaffIDPWS(staff_id),5)
                        .build();
            } else {
                Log.i("PagedList", "ReportedModelClass: inside blank just staff ID");
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListBySearchPWS(staff_id,filterTextAll.getValue()),5)
                        .build();
            }
    ...
    public PWSFieldListPageListModelClass(FieldsDao fieldsDao, Context context, String unique_field_id,
        ...
        pwsFieldListRecyclerModel = Transformations.switchMap(filterTextAll, input -> {
            if (input == null || input.equals("") || input.equals("%%") ||input.equals("% %")) {
                ...
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListByActivitySearchPWS(staff_id,
    ...
    public PWSFieldListPageListModelClass(FieldsDao fieldsDao, Context context, double min_lat,
        ...
        pwsFieldListRecyclerModel = Transformations.switchMap(filterTextAll, input -> {
            if (input == null || input.equals("") || input.equals("%%") ||input.equals("% %")) {
                ...
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListByGridPWS(staff_id,this.min_lat,this.max_lat,this.min_lng,this.max_lng),5)
                        .build();
            } else {
                Log.i("PagedList", "ReportedModelClass: inside grid ");
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListByGridPWS(staff_id,this.min_lat,this.max_lat,this.min_lng,this.max_lng,filterTextAll.getValue()),5)
                        .build();
            }
