...
public class FieldListPageListModelClass extends ViewModel {
    ...
    public final LiveData<PagedList<FieldListRecyclerModel>> fieldListRecyclerModel;
    public MutableLiveData<String> filterTextAll       = new MutableLiveData<>();

    public FieldListPageListModelClass(FieldsDao fieldsDao, Context context) {
        this.fieldsDao = fieldsDao;
        this.context = context;
        SharedPrefs sharedPrefs = new SharedPrefs(this.context);
        String staff_id = "%"+sharedPrefs.getStaffID()+"%";

        fieldListRecyclerModel = Transformations.switchMap(filterTextAll, input -> {
            if (input == null || input.equals("") || input.equals("%%") ||input.equals("% %")) {
                ...
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListByStaffID(staff_id),5)
                        .build();
            } else {
                Log.i("PagedList", "ReportedModelClass: inside blank just staff ID");
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListBySearch(staff_id,filterTextAll.getValue()),5)
                        .build();
            }
    ...
    public FieldListPageListModelClass(FieldsDao fieldsDao, Context context, String unique_field_id,
        ...
        fieldListRecyclerModel = Transformations.switchMap(filterTextAll, input -> {
            if (input == null || input.equals("") || input.equals("%%") ||input.equals("% %")) {
                ...
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListByActivitySearch(staff_id,
    ...
    public FieldListPageListModelClass(FieldsDao fieldsDao, Context context, double min_lat,
        ...
        fieldListRecyclerModel = Transformations.switchMap(filterTextAll, input -> {
            if (input == null || input.equals("") || input.equals("%%") ||input.equals("% %")) {
                ...
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListByGrid(staff_id,this.min_lat,this.max_lat,this.min_lng,this.max_lng),5)
                        .build();
            } else {
                Log.i("PagedList", "ReportedModelClass: inside grid ");
                return new LivePagedListBuilder<>(
                        this.fieldsDao.getFieldListByGrid(staff_id,this.min_lat,this.max_lat,this.min_lng,this.max_lng,filterTextAll.getValue()),5)
                        .build();
            }
