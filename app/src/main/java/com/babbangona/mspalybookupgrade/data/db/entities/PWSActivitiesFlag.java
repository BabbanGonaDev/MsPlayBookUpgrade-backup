...
@Entity(primaryKeys = {DatabaseStringConstants.COL_PWS_ID},
        tableName = DatabaseStringConstants.PWS_ACTIVITY_FLAGS_TABLE)
public class PWSActivitiesFlag {
    ...
    public PWSActivitiesFlag(@NonNull String pws_id, String unique_field_id, String ik_number,
