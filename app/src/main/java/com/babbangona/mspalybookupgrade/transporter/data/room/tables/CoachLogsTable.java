...
public class CoachLogsTable {
    ...
    public CoachLogsTable(@NonNull String member_id, @NonNull Integer quantity, String transported_by, @NonNull String transporter_id, String voucher_id, Integer voucher_id_flag, String cc_id, Integer instant_payment_flag, @NonNull String date_logged, Integer sync_flag) {
