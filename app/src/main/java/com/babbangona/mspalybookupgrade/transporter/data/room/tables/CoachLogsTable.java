...
@Entity(tableName = "coach_logs_table", primaryKeys = {"member_id", "quantity", "transporter_id", "date_logged"})
public class CoachLogsTable {
    ...
    public CoachLogsTable(@NonNull String member_id, @NonNull Integer quantity, String transported_by, @NonNull String transporter_id, String voucher_id, Integer voucher_id_flag, String cc_id, Integer instant_payment_flag, String staff_id, String imei, String app_version, @NonNull String date_logged, Integer sync_flag) {
