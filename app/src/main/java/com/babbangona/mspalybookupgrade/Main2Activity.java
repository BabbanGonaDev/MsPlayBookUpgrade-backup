...
import com.babbangona.mspalybookupgrade.RecyclerAdapters.ActivityListAdapter;
...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefs = new SharedPrefs(Main2Activity.this);
        main2ActivityMethods = new Main2ActivityMethods(Main2Activity.this);
        appDatabase = AppDatabase.getInstance(Main2Activity.this);
...
//            checkNetworkConnection();
    ...
    public void initActivitiesRecycler(){
        runOnUiThread(() -> {
            activityListAdapter = new ActivityListAdapter(main2ActivityMethods.composingRecyclerList(),Main2Activity.this);
            RecyclerView.LayoutManager aLayoutManager = new LinearLayoutManager(Main2Activity.this);
