...
public class FertilizerMembersDownload {

    @SerializedName("download_list")
    private List<FertilizerMembers> download_list;

    @SerializedName("last_sync_time")
    private String last_sync_time;

    public List<FertilizerMembers> getDownload_list() {
        return download_list;
    }

    public void setDownload_list(List<FertilizerMembers> download_list) {
