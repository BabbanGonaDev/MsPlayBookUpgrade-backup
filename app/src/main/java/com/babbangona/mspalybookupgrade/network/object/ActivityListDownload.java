...
public class ActivityListDownload {

    @SerializedName("download_list")
    private List<ActivityList> download_list;

    @SerializedName("last_sync_time")
    private String last_sync_time;

    public List<ActivityList> getDownload_list() {
        return download_list;
    }

    public void setDownload_list(List<ActivityList> download_list) {
